...
<body>
  <main class="board-shell">
    <header class="board-header">
      ...
      <nav class="primary-actions" aria-label="Acciones principales">
        <a class="action action-primary" href="/voluntario/registro">Registrarme como voluntario</a>
        <a class="action action-secondary" href="/necesidad/nueva">Publicar necesidad</a>
      </nav>
